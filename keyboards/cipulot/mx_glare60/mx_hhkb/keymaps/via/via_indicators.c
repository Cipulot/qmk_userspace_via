...
void via_config_set_value(uint8_t *data) {
    ...
    switch (data_index) {
        case 1: {
            ...
            if (indi_index == 0) {
                EEPROM_KB_PARTIAL_UPDATE(eeprom_mx_hhkb_config, ind1.enabled);
            } else if (indi_index == 1) {
                EEPROM_KB_PARTIAL_UPDATE(eeprom_mx_hhkb_config, ind2.enabled);
            }
            break;
        }
        case 2: {
            ...
            if (indi_index == 0) {
                EEPROM_KB_PARTIAL_UPDATE(eeprom_mx_hhkb_config, ind1.v);
            } else if (indi_index == 1) {
                EEPROM_KB_PARTIAL_UPDATE(eeprom_mx_hhkb_config, ind2.v);
            }
            break;
        }
        case 3: {
            ...
            if (indi_index == 0) {
                EEPROM_KB_PARTIAL_UPDATE(eeprom_mx_hhkb_config, ind1.h);
                EEPROM_KB_PARTIAL_UPDATE(eeprom_mx_hhkb_config, ind1.s);
            } else if (indi_index == 1) {
                EEPROM_KB_PARTIAL_UPDATE(eeprom_mx_hhkb_config, ind2.h);
                EEPROM_KB_PARTIAL_UPDATE(eeprom_mx_hhkb_config, ind2.s);
            }
            break;
        }
        case 4: {
            ...
            if (indi_index == 0) {
                EEPROM_KB_PARTIAL_UPDATE(eeprom_mx_hhkb_config, ind1.func);
            } else if (indi_index == 1) {
                EEPROM_KB_PARTIAL_UPDATE(eeprom_mx_hhkb_config, ind2.func);
            }
            break;
        }
        default: {
